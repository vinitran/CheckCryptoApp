...
const ListCoinInHome = ({name, symbol, sparkLine, currentPrice, priceChangePersentage7d, logoUrl, navigation, marketCapRank, market_cap}) => {
    ...
    <TouchableOpacity 
        activeOpacity={0.5}
        onPress={() => navigation.navigate('DetailCoin',{
            name,
            symbol,
            currentPrice,
