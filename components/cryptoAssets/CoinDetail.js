...
export default function ListCoinScreen({route,navigation}) {
          ...
          <SafeAreaView>
            ...
            <View style={styles.menuWrapper}>
              ...
              <View style={styles.priceAndPersentChangeWrapper}>
                <Text style={styles.currentPrice}>US${route.params.currentPrice.toLocaleString("en-US",{currency: "USD"})}</Text>
